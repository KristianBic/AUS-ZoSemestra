...
void main(array<String^>^)
{
	...
	structures::FileLogConsumer* fileLogConsumer = new structures::FileLogConsumer("test.csv");
...
// MainForm:
	...
	System::Void gui::MainForm::LogDuration(tests::Milliseconds duration, const std::string& message)
	{
		String^ str = ", Duration: " + duration.count() + " microseconds, " + gcnew String(message.c_str());
