...
namespace structures
{
	...
	{
		return this->root_ != nullptr ?this->root_->sizeOfSubtree() : 0;
	}
	...
	{
		*this->path_ = *dynamic_cast<TreeIterator&>(other).path_;
		return *this;
	}
	...
	{
		return *this->path_ != *dynamic_cast<TreeIterator&>(other).path_;
