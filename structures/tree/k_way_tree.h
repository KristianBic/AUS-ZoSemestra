...
namespace structures
{
	...
	{
		//Nemozeme pridat insert do k_way_tree pretoze uz mame danu velkost stromu...
		throw std::logic_error("KWayTreeNode<T>::insertSon: Neni mozne pridat syna do k-cestneho stromu");
		//dalo by sa aj takto->
	...
	{	
		KWayTreeNode<T, K>* result = this->children_->at(order);
