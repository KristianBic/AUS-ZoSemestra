...
namespace structures
{
    ...
    void PriorityQueueLimitedSortedArrayList<T>::push(int priority, const T& data)
    {
        ...
        {
            throw std::logic_error("PriorityQueueLimitedSortedArrayList - push - exeeded capacity");
        }
    }
    ...
    inline int PriorityQueueLimitedSortedArrayList<T>::minPriority()
    {
		...
		{
			throw std::logic_error("PriorityQueueLimitedSortedArrayList - minPriority - Priority queue is empty.");
		}
