...
namespace structures
{
	...
	//!!!!!!!!!!!!!!!!!!!!!
	//ked vkladame do pola objekty tak musime vzdy vkladat pointre na objekty a nie samotne objekty
	...
	//priradenie cize aby sme pole vedeli dat do pola
	template<typename T>
	...
	//zistujeme ci obsah je rovnaky (ci su v nich rovnake data) {nezistujeme ze ci 2 polia ukazuju na rovnaky blok pamete}
	template<typename T>
	...
	//zobere si index pola a premapuje ho na index vo velktore (napr mame 3. index z pola ale vo vektore to je : ak je int tak to je 4x3 = 12. prvok)
	template<typename T>
